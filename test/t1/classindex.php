...
echo "<br>";
$res=mysqli_query($database,"select password from classes where email='$email'");
...
if($result[0]=="")
{
	...
	echo "<button onclick=\"location.href = 'register.html';\" id=\"myButton\" class=\"float-left submit-button\" >Click Here To Sign Up!</button>";
