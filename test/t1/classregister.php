...
echo "<br>";
$res=mysqli_query($database,"select * from classes where email='$email'");
...
if(mysqli_query ($database,"insert into classes(email,password) values('$email','$password')"))
{
	
			echo "Registration Successful";
			echo "<button onclick=\"location.href = 'classindex.html';\" id=\"myButton\" class=\"float-left submit-button\" >Click Here To Log In!</button>";
